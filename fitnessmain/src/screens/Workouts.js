...
<ImageBackground source={require('../../src/assets/images/goals.jpg')} style={styles.card_general}>
...
<ImageBackground source={require('../../src/assets/images/levels.jpg')} style={styles.card_general}>
<LinearGradient colors={['rgba(0,0,0,0.6)', 'rgba(0,0,0,0.9)']} style={styles.gradient_general}>                        
