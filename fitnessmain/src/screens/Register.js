...
import { Container, Body, Footer, Header, Input, Item, Left, Text, Title, Right, View, Button, Toast,Picker} from 'native-base';
	...
	*/
	...
	render () {
		return (
			...
			<Header style={{backgroundColor: '#E7FDFF', borderBottomWidth: 0, shadowOpacity: 0, elevation: 0,}}>
			<Left style={{ flex: 1 }}>
            <Button transparent>
		...
		<View style={{flex: 0.8, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: 20}}>
			<Image source={require('../../src/assets/images/new_logo.png')} style={styles.logo_start} resizeMode="contain"/>
            <Title style={{color: '#000000',paddingBottom:30,fontWeight:'bold',fontSize:24}}>Register with Us</Title>
                        ...
                        alignSelf: 'center',marginBottom:20
							...
							<Picker.Item label="Female" value="Female" />
										...
										<Button  block onPress={this.register.bind(this)} style={styles.button_auth}>
