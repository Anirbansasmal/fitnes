...
import { Container, Text, Body, Right, List, ListView, Thumbnail, ListItem,Left} from 'native-base';
...
getData = async () => {
  ...
  DietDetails (item) {
    this.props.navigation.navigate('DietNew', { data: item});  
    console.log(item)  
  }
  render() {
  // displayName = 'chandan';
    ...
    {this.state.userDiet.length < 1 ? <Text>No Diet Chart Available</Text>:
    <List>
      <ListItem >
